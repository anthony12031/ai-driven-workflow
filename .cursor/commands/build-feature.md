...
4. **Implementation** — Set status `IN_PROGRESS`. For each task: implement using **code-gen** and language **rules**; add tests with the **testing** skill; mark tasks complete in the spec.
